...
function ElementsStory({chart}:{chart:Chart}){return <div className="elementsStory"><p className="eyebrow">TU MEZCLA, DE UN VISTAZO</p><h2>No necesitas equilibrio perfecto.<br/>Necesitas conocer tu mezcla.</h2><ElementRow chart={chart}/><p>Lo alto es acceso fácil. Lo bajo es práctica consciente. Ningún elemento es premio ni castigo.</p><ShareActions kind="elements" chart={chart} shareLabel="Compartir mi gráfica"/></div>}
